...
#include "ArcFastGeoVisualizationTrait.generated.h"

class UStaticMesh;
class UMaterialInterface;

UCLASS(BlueprintType, EditInlineNew, CollapseCategories, meta = (DisplayName = "Arc FastGeo Visualization", Category = "Visualization"))
class ARCMASS_API UArcFastGeoVisualizationTrait : public UMassEntityTraitBase
{
	GENERATED_BODY()
...
public:
	...
	bool GetCastHiddenShadow() const { return bCastHiddenShadow; }
	bool GetCastContactShadow() const { return bCastContactShadow; }
	bool GetReceivesDecals() const { return bReceivesDecals; }
	bool GetRenderCustomDepth() const { return bRenderCustomDepth; }
	int64 GetCustomDepthStencilValue() const { return CustomDepthStencilValue; }
