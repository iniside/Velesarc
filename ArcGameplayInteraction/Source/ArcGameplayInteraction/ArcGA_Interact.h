...
UCLASS()
class ARCGAMEPLAYINTERACTION_API UArcGA_Interact : public UArcCoreGameplayAbility
{
	GENERATED_BODY()
...
protected:
	 ...
	 * Default implementation calls BeginInteraction on actor targets,
	 * or delegates to UArcEntityInteractionComponent for entity targets.
	 */
