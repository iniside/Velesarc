 ...
 * backed by a GameplayEffect. Magnitudes are scaled by quality.
 */
USTRUCT(BlueprintType, meta = (DisplayName = "Craft Attribute Modifier"))
struct ARCCRAFT_API FArcCraftModifier_AttributeModifier : public FArcCraftModifier
{
	GENERATED_BODY()
