...
class ARCTARGETQUERY_API AArcTQSTestingActor : public AActor
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Query|Inline",
		meta = (BaseStruct = "/Script/ArcTargetQuery.ArcTQSContextProvider", EditCondition = "bUseInlineDefinition"))
	FInstancedStruct InlineContextProvider;

	// Generator that produces the initial target pool
	UPROPERTY(EditAnywhere, Category = "Query|Inline",
		meta = (BaseStruct = "/Script/ArcTargetQuery.ArcTQSGenerator", EditCondition = "bUseInlineDefinition"))
	FInstancedStruct InlineGenerator;

	// Ordered pipeline of filter/score steps
	UPROPERTY(EditAnywhere, Category = "Query|Inline",
		meta = (BaseStruct = "/Script/ArcTargetQuery.ArcTQSStep", EditCondition = "bUseInlineDefinition"))
