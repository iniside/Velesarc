...
struct ARCTARGETQUERY_API FArcTQSLocationConfig
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, Category = "Location", meta = (BaseStruct = "/Script/ArcTargetQuery.ArcTQSLocationProvider", ExcludeBaseStruct, EditCondition = "AdditionalSource == EArcTQSLocationSource::CustomProvider", EditConditionHides))
 ...
 */
USTRUCT(BlueprintType)
struct ARCTARGETQUERY_API FArcTQSLocationProvider
{
	GENERATED_BODY()
...
struct ARCTARGETQUERY_API FArcTQSLocationProvider_Querier : public FArcTQSLocationProvider
{
	GENERATED_BODY()
...
struct ARCTARGETQUERY_API FArcTQSLocationProvider_NearestContext : public FArcTQSLocationProvider
{
	GENERATED_BODY()
...
struct ARCTARGETQUERY_API FArcTQSLocationProvider_ContextByIndex : public FArcTQSLocationProvider
{
	GENERATED_BODY()
...
struct ARCTARGETQUERY_API FArcTQSLocationProvider_AllContexts : public FArcTQSLocationProvider
{
	GENERATED_BODY()
