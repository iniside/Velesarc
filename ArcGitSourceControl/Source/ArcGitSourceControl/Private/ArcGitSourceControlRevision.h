...
class FArcGitSourceControlRevision : public ISourceControlRevision
{
public:
	FArcGitSourceControlRevision()
		: RevisionNumber(0)
	{
	}
...
public:
	...
	TSharedPtr<FArcGitSourceControlRevision, ESPMode::ThreadSafe> BranchSource;
	...
	/** Path to git binary for annotation support */
	FString PathToGitBinary;

	/** Path to repository root for annotation support */
	FString PathToRepositoryRoot;
};

/** History composed of the last 100 revisions of the file */
typedef TArray< TSharedRef<FArcGitSourceControlRevision, ESPMode::ThreadSafe> >	TArcGitSourceControlHistory;
