...
public:
	...
	virtual void SettingChanged(const ULocalPlayer* LocalPlayer, UGameSetting* Setting, EGameSettingChangeReason Reason) const override
	{
		...
		const UArcLocalPlayerBase* LyraLocalPlayer = CastChecked<UArcLocalPlayerBase>(LocalPlayer);
		LyraLocalPlayer->GetLocalSettingsTyped<ULyraSettingsLocal>()->ApplyScalabilitySettings();
	}
...
UGameSettingCollection* ULyraGameSettingRegistry::InitializeVideoSettings(UArcLocalPlayerBase* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetFullscreenMode));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetFullscreenMode));
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetColorBlindMode));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetColorBlindMode));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetColorBlindStrength));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetColorBlindStrength));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetDisplayGamma));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetDisplayGamma));
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetDesiredDeviceProfileQualitySuffix));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetDesiredDeviceProfileQualitySuffix));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetCustomAction([](ULocalPlayer* LocalPlayer)
			{
				...
				else
				{
					...
					LyraLocalPlayer->GetLocalSettingsTyped<ULyraSettingsLocal>()->RunAutoBenchmark(bImmediatelySaveState);
				}
			});
			...
			Setting->AddEditCondition(MakeShared<FWhenCondition>([](const ULocalPlayer* LocalPlayer, FGameSettingEditableState& InOutEditState)
			{
				...
				const UArcLocalPlayerBase* LyraLocalPlayer = CastChecked<UArcLocalPlayerBase>(LocalPlayer);
				const bool bCanBenchmark = LyraLocalPlayer->GetLocalSettingsTyped<ULyraSettingsLocal>()->CanRunAutoBenchmark();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetResolutionScaleNormalized));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetResolutionScaleNormalized));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetGlobalIlluminationQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetGlobalIlluminationQuality));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetShadowQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetShadowQuality));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetAntiAliasingQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetAntiAliasingQuality));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetViewDistanceQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetViewDistanceQuality));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetTextureQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetTextureQuality));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetVisualEffectQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetVisualEffectQuality));
			Setting->AddOption(0, LOCTEXT("VisualEffectQualityLow", "Low"));
			Setting->AddOption(1, LOCTEXT("VisualEffectQualityMedium", "Medium"));
			Setting->AddOption(2, LOCTEXT("VisualEffectQualityHigh", "High"));
			Setting->AddOption(3, LOCTEXT("VisualEffectQualityEpic", "Epic"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetReflectionQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetReflectionQuality));
			Setting->AddOption(0, LOCTEXT("VisualEffectQualityLow", "Low"));
			Setting->AddOption(1, LOCTEXT("VisualEffectQualityMedium", "Medium"));
			Setting->AddOption(2, LOCTEXT("VisualEffectQualityHigh", "High"));
			Setting->AddOption(3, LOCTEXT("VisualEffectQualityEpic", "Epic"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetPostProcessingQuality));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetPostProcessingQuality));
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(IsVSyncEnabled));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetVSyncEnabled));
...
void ULyraGameSettingRegistry::InitializeVideoSettings_FrameRates(UGameSettingCollection* Screen, UArcLocalPlayerBase* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		UGameSettingValueDiscreteDynamic_Number* Setting = NewObject<UGameSettingValueDiscreteDynamic_Number>();
		...
		Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetFrameRateLimit_OnBattery));
		Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetFrameRateLimit_OnBattery));
		...
		Arcx::Settings::AddFrameRateOptions(Setting);
	...
	//----------------------------------------------------------------------------------
	{
		...
		Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetFrameRateLimit_InMenu));
		Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetFrameRateLimit_InMenu));
	...
	//----------------------------------------------------------------------------------
	{
		...
		Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetFrameRateLimit_WhenBackgrounded));
		Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetFrameRateLimit_WhenBackgrounded));
	...
	//----------------------------------------------------------------------------------
	{
		...
		Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetFrameRateLimit_Always));
		Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetFrameRateLimit_Always));
