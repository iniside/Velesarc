 ...
 */
UCLASS()
class ARCFRONTEND_API ULyraSettingsShared : public ULocalPlayerSaveGame
{
	GENERATED_BODY()
...
public:
	...
	static ULyraSettingsShared* CreateTemporarySettings(const UArcLocalPlayerBase* LocalPlayer);
	
	/** Synchronously loads a settings object, this is not valid to call before login */
	static ULyraSettingsShared* LoadOrCreateSettings(const UArcLocalPlayerBase* LocalPlayer);
	...
	static bool AsyncLoadOrCreateSettings(const UArcLocalPlayerBase* LocalPlayer, FOnSettingsLoadedEvent Delegate);
