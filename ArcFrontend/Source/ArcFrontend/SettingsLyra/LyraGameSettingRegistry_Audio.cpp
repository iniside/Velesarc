...
UGameSettingCollection* ULyraGameSettingRegistry::InitializeAudioSettings(UArcLocalPlayerBase* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetOverallVolume));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetOverallVolume));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetMusicVolume));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetMusicVolume));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetSoundFXVolume));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetSoundFXVolume));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetDialogueVolume));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetDialogueVolume));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetVoiceChatVolume));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetVoiceChatVolume));
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			////////////////////////////////////////////////////////////////////////////////////
			{
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetSubtitlesEnabled));
					Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetSubtitlesEnabled));
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetSubtitlesTextSize));
					Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetSubtitlesTextSize));
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetSubtitlesTextColor));
					Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetSubtitlesTextColor));
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetSubtitlesTextBorder));
					Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetSubtitlesTextBorder));
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetSubtitlesBackgroundOpacity));
					Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetSubtitlesBackgroundOpacity));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(GetAudioOutputDeviceId));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetAudioOutputDeviceId));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(GetAllowAudioInBackgroundSetting));
			Setting->SetDynamicSetter(GET_SHARED_SETTINGS_FUNCTION_PATH_LYRA(SetAllowAudioInBackgroundSetting));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(bDesiredHeadphoneMode));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(bDesiredHeadphoneMode));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDynamicGetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(bUseHDRAudioMode));
			Setting->SetDynamicSetter(GET_LOCAL_SETTINGS_FUNCTION_PATH_LYRA(SetHDRAudioModeEnabled));
