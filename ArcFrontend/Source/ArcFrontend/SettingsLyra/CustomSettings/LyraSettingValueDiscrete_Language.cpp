...
{
	if (ULyraSettingsShared* Settings = CastChecked<UArcLocalPlayerBase>(LocalPlayer)->GetSharedSettingsTyped<ULyraSettingsShared>())
	{
...
{
	if (const ULyraSettingsShared* Settings = CastChecked<UArcLocalPlayerBase>(LocalPlayer)->GetSharedSettingsTyped<ULyraSettingsShared>())
	{
