...
#include "ArcScalarSettingViewModel.generated.h"

class UArcSettingsModel;

UCLASS()
class ARCGAMESETTINGS_API UArcScalarSettingViewModel : public UMVVMViewModelBase
{
	GENERATED_BODY()
...
public:
	...
	void SetValue(double InValue, UArcSettingsModel* InModel);

	UFUNCTION(BlueprintCallable)
	void SetNormalizedValue(double InNormalized, UArcSettingsModel* InModel);
