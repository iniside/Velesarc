...
#include "ArcItemFragment_SkeletalMeshAttachment.h"
...
bool FArcAttachmentHandler_SkeletalMesh::HandleItemAddedToSlot(UArcItemAttachmentComponent* InAttachmentComponent
															   ...
															   , const FArcItemData* InOwnerItem) const
{
	...
	const FArcItemFragment_SkeletalMeshAttachment* Fragment = ArcEquipmentUtils::GetAttachmentFragment<FArcItemFragment_SkeletalMeshAttachment>(InItem, VisualItemDefinition);
...
void FArcAttachmentHandler_SkeletalMesh::HandleItemAttach(UArcItemAttachmentComponent* InAttachmentComponent
	...
	, const FArcItemId InOwnerItem) const
{
	...
	USkeletalMesh* SkeletalMesh = Fragment->SkeletalMesh.Get();
	if (!SkeletalMesh)
	{
		return;
	}
	...
	SpawnedComponent->SetSkeletalMesh(SkeletalMesh);
