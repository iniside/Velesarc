...
#include "ArcItemFragment_StaticMeshComponentAttachment.generated.h"
...
public:
	...
	TSoftClassPtr<UStaticMeshComponent> StaticMeshAttachClass = UStaticMeshComponent::StaticClass();
...
public:
	...
	{
		return FArcItemFragment_StaticMeshComponentAttachment::StaticStruct();
	}
	
	virtual ~FArcAttachmentHandler_ComponentStaticMesh() override = default;
};