...
#include "ArcItemStatReplicatedNetSerializer.generated.h"

USTRUCT()
struct FArcItemStatReplicatedNetSerializerConfig : public FNetSerializerConfig
{
	GENERATED_BODY()
};
...
namespace Arcx::Net
{
	UE_NET_DECLARE_SERIALIZER(FArcItemStatReplicatedNetSerializer
		, ARCCORE_API);
}
