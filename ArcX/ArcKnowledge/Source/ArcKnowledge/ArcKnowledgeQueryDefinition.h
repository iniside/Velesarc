...
class ARCKNOWLEDGE_API UArcKnowledgeQueryDefinition : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Query", meta = (BaseStruct = "/Script/ArcKnowledge.ArcKnowledgeFilter"))
	TArray<FInstancedStruct> Filters;

	/** Scorer pipeline — score entries 0-1, multiplicative. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Query", meta = (BaseStruct = "/Script/ArcKnowledge.ArcKnowledgeScorer"))
