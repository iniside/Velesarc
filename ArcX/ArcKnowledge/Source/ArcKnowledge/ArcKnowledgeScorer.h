...
struct ARCKNOWLEDGE_API FArcKnowledgeScorer
{
	GENERATED_BODY()
...
struct ARCKNOWLEDGE_API FArcKnowledgeScorer_Distance : public FArcKnowledgeScorer
{
	GENERATED_BODY()
...
struct ARCKNOWLEDGE_API FArcKnowledgeScorer_Relevance : public FArcKnowledgeScorer
{
	GENERATED_BODY()
...
struct ARCKNOWLEDGE_API FArcKnowledgeScorer_Freshness : public FArcKnowledgeScorer
{
	GENERATED_BODY()
 ...
 * Bridges ArcKnowledge queries with ArcMass influence maps.
 *
...
struct ARCKNOWLEDGE_API FArcKnowledgeScorer_Influence : public FArcKnowledgeScorer
{
	GENERATED_BODY()
