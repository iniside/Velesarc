...
struct FArcMassQueryKnowledgeTaskInstanceData
{
	...
	UPROPERTY(EditAnywhere, Category = Parameter, meta = (BaseStruct = "/Script/ArcSettlement.ArcKnowledgeFilter", EditCondition = "bUseInlineDefinition"))
	TArray<FInstancedStruct> InlineFilters;

	/** Inline scorer pipeline. */
	UPROPERTY(EditAnywhere, Category = Parameter, meta = (BaseStruct = "/Script/ArcSettlement.ArcKnowledgeScorer", EditCondition = "bUseInlineDefinition"))
 ...
 */
USTRUCT(meta = (DisplayName = "Arc Query Knowledge", Category = "Arc|Settlement"))
struct ARCSETTLEMENT_API FArcMassQueryKnowledgeTask : public FMassStateTreeTaskBase
{
	GENERATED_BODY()
