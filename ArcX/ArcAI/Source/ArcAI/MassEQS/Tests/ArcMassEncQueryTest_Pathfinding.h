...
#include "ArcMassEncQueryTest_Pathfinding.generated.h"

class ANavigationData;
class UNavigationSystemV1;

UENUM()
enum class EArcEnvTestPathfinding : uint8
{
	PathExist,
	PathCost,
	PathLength,
 ...
 */
UCLASS()
class ARCAI_API UArcMassEncQueryTest_Pathfinding : public UEnvQueryTest
{
	GENERATED_UCLASS_BODY()

	/** testing mode */
	UPROPERTY(EditDefaultsOnly, Category=Pathfinding)
	EArcEnvTestPathfinding TestMode;
...
protected:
	...
	ANavigationData* FindNavigationData(UNavigationSystemV1& NavSys, const FVector& InLocation) const;
