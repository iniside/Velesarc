    ...
    , UArcTargetingObject* InTrace)
{
	...
	if (WC->GetOwner()->HasAuthority())
	{
		...
		const FArcItemInstance_EffectToApply* Instance = ArcItemsHelper::FindInstance<FArcItemInstance_EffectToApply>(Item);
		if (Instance == nullptr)
		{
			return;
		}
  ...
  , UArcTargetingObject* InTrace)
{
	...
	const FGameplayAbilityActorInfo* ActorInfo = Ability->GetCurrentActorInfo();
	UArcItemGameplayAbility* ArcGA = Cast<UArcItemGameplayAbility>(Ability);
	...
	if (WC->GetOwner()->HasAuthority())
	{
		...
		const FArcItemInstance_EffectToApply* Instance = ArcItemsHelper::FindInstance<FArcItemInstance_EffectToApply>(SlotItem);
  ...
  , class UArcTargetingObject* InTrace)
{
	...
	UArcItemGameplayAbility* AuAB = Cast<UArcItemGameplayAbility>(Ability);
