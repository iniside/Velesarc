...
bool FArcGunInstanceBase::CommitAmmo(const FArcItemData* InItem, class UArcGunStateComponent* InComponent)
{
	...
	FArcItemInstance_GunMagazineAmmo* Instance = ArcItemsHelper::FindMutableInstance<FArcItemInstance_GunMagazineAmmo>(InItem);
	if (Instance == nullptr)
	{
		return true;
	}
	...
	ArcItemsHelper::BroadcastItemChanged(InItem);
