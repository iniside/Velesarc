...
#include "ArcCoreEditorEngine.generated.h"
/**
 *
 */
UCLASS()
class ARCCOREEDITOR_API UArcCoreEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:
	UArcCoreEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
