...
#include "ArcItemFragment_SkeletalMeshComponentAttachment.generated.h"
...
public:
	...
	TSoftClassPtr<USkeletalMeshComponent> SkeletalMeshComponentClass;
...
public:
	...
	{
		return FArcItemFragment_SkeletalMeshComponentAttachment::StaticStruct();
	}
	
	virtual ~FArcAttachmentHandler_SkeletalMeshComponent() override = default;
};