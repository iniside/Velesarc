...
public:
	...
	UPROPERTY()
	mutable TObjectPtr<UMassAgentComponent> InstigatorMassAgent = nullptr;

	UPROPERTY()
	mutable TObjectPtr<UMassEntitySubsystem> CachedMassEntitySubsystem = nullptr;
...
public:
	...
	UMassAgentComponent* GetInstigatorMassAgent() const;
	UMassEntitySubsystem* GetMassEntitySubsystem() const;
	FMassEntityHandle GetInstigatorEntity() const;
	FMassEntityManager* GetMassEntityManager() const;

	void SetInstigatorMassAgent(UMassAgentComponent* InAgent)
	{
		InstigatorMassAgent = InAgent;
	}

	void SetMassEntitySubsystem(UMassEntitySubsystem* InSubsystem)
	{
		CachedMassEntitySubsystem = InSubsystem;
	}

	void SetInstigatorEntity(FMassEntityHandle InEntity)
	{
		InstigatorEntity = InEntity;
	}
