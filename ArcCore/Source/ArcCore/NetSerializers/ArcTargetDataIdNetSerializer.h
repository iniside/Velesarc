...
#include "ArcTargetDataIdNetSerializer.generated.h"

USTRUCT()
struct ARCCORE_API FArcTargetDataIdNetSerializerConfig : public FNetSerializerConfig
{
	GENERATED_BODY()
};
...
namespace Arcx::Net
{
	UE_NET_DECLARE_SERIALIZER(FArcTargetDataIdNetSerializer
		, ARCCORE_API);
	...
	struct FArcTargetDataIdNetSerializer
	{
		...
		using ConfigType = FArcTargetDataIdNetSerializerConfig;

		static ConfigType DefaultConfig;
		using SourceType = FArcTargetDataId;
		...
		static FArcTargetDataIdNetSerializer::FNetSerializerRegistryDelegates NetSerializerRegistryDelegates;
	};
}
