...
/**
 * Ends the owning gameplay ability. Set bWasCancelled to true to signal that the
 * ability was interrupted rather than completing normally. This also tears down
 * any active latent actions registered on the ability.
 */
