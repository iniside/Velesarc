...
#include "ArcAbilityAction_ApplyCost.generated.h"

/**
 * Applies the ability's cost gameplay effect, consuming the required resources.
 * The cost effect class is defined on the ability itself.
