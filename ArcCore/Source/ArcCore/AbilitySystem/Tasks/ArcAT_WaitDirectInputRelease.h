...
#include "ArcAT_WaitDirectInputRelease.generated.h"

/**
 *
 */
UCLASS()
class ARCCORE_API UArcAT_WaitDirectInputRelease : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UArcAT_WaitDirectInputRelease* WaitDirectInputRelease(UGameplayAbility* OwningAbility
