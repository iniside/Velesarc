...
#include "ArcAT_PlayMontageFromItemWaitForEvent.generated.h"
 ...
 */
UCLASS()
class ARCCORE_API UArcAT_PlayMontageFromItemWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
		GENERATED_BODY()
...
public:
	...
	UArcAT_PlayMontageFromItemWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	static UArcAT_PlayMontageFromItemWaitForEvent* PlayMontageFromItemWaitForEvent (UGameplayAbility* OwningAbility
...
private:
	...
	void HandleActivationTimeChanged(UArcCoreGameplayAbility* InAbility
									 , float NewTime);
	bool PlayMontage();
