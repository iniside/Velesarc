...
#include "ArcBroadcastEffectEventsGameplayEffectComponent.generated.h"

struct FGameplayEffectRemovalInfo;

UCLASS(DisplayName="Broadcast Gameplay Effect Events")
class UArcBroadcastEffectEventsGameplayEffectComponent : public UGameplayEffectComponent
{
	GENERATED_BODY()
