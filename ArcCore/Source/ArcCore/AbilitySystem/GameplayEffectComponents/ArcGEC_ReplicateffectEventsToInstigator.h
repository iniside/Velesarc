...
#include "ArcGEC_ReplicateffectEventsToInstigator.generated.h"

struct FGameplayEffectRemovalInfo;
/**
 * 
 */
UCLASS(DisplayName="Replicate Effect Events to Instigator")
class ARCCORE_API UArcGEC_ReplicateffectEventsToInstigator : public UGameplayEffectComponent
{
	GENERATED_BODY()
