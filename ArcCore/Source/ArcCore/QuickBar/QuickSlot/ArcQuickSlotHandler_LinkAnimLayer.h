...
#include "ArcQuickSlotHandler_LinkAnimLayer.generated.h"
/**
 * 
 */
USTRUCT(meta = (DisplayName = "Arc Link Anim Layer"))
struct ARCCORE_API FArcQuickSlotHandler_LinkAnimLayer : public FArcQuickSlotHandler
{
	GENERATED_BODY()
...
public:
	...
	virtual ~FArcQuickSlotHandler_LinkAnimLayer() override = default;
};