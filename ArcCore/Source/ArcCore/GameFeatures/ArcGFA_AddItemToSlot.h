...
#include "ArcGFA_AddItemToSlot.generated.h"
 ...
 * specified type.
 */
UCLASS(MinimalAPI, meta = (DisplayName = "Add Item To Slot"))
class UArcGFA_AddItemToSlot final : public UGameFeatureAction
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "Item")
	TSubclassOf<UArcItemsStoreComponent> ItemStoreComponentClass;
