...
#include "ArcMassAttachmentHandler_SkeletalMesh.generated.h"

USTRUCT(meta = (DisplayName = "Mass Skeletal Mesh Attachment"))
struct ARCMASSITEMSRUNTIME_API FArcMassAttachmentHandler_SkeletalMesh : public FArcMassAttachmentHandlerCommon
{
	GENERATED_BODY()
