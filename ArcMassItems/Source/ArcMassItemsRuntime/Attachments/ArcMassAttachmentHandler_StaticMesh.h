...
#include "ArcMassAttachmentHandler_StaticMesh.generated.h"

USTRUCT(meta = (DisplayName = "Mass Static Mesh Attachment"))
struct ARCMASSITEMSRUNTIME_API FArcMassAttachmentHandler_StaticMesh : public FArcMassAttachmentHandlerCommon
{
	GENERATED_BODY()
