...
#include "ArcMassAttachmentHandler_AnimLayer.generated.h"

USTRUCT(meta = (DisplayName = "Mass Anim Layer Attachment"))
struct ARCMASSITEMSRUNTIME_API FArcMassAttachmentHandler_AnimLayer : public FArcMassAttachmentHandlerCommon
{
	GENERATED_BODY()
...
public:
	...
	{
		return FArcItemFragment_AnimLayer::StaticStruct();
	}
};
