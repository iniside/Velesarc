...
#include "ArcMassAttachmentHandler_Actor.generated.h"

USTRUCT(meta = (DisplayName = "Mass Actor Attachment"))
struct ARCMASSITEMSRUNTIME_API FArcMassAttachmentHandler_Actor : public FArcMassAttachmentHandlerCommon
{
	GENERATED_BODY()
